...
Our baseline system uses an Integer Linear Program (ILP) to find a summary that maximizes the total score, which is a commen technique in summarization tasks \citep{recent-advances}. %CHECK!
...
$f_{ling*TR^{(date)}}$   & 0.418    & 0.307 & 0.058 & 0.055 & 0.014 & 0.066 & 0.015 \\\hline
$f_{ling*TR^{(global)}}$     & 0.434    & 0.315 & 0.062 & 0.055 & 0.013 & 0.067 & 0.014 \\\hline
$f_{\text{ling}*TR^{(cluster)}}$     & 0.438    & 0.309$^{\ddagger}$    & 0.060$^{\ddagger}$    & 0.059$^{\ddagger}$    & 0.016$^{\ddagger}$    & 0.069$^{\ddagger}$    & 0.018$^{\ddagger}$ \\\hline
$f_{ling*TR^{(temp)}}$   & 0.430    & 0.313 & 0.060 & 0.058 & 0.016$^{a}$   & 0.069 & 0.017$^{a}$ \\\hline
\multicolumn{8}{|l|}{ \textit{Affinity Propagation} }\\\hline
$f_{ling*TR^{(date)}}$   & 0.434    & 0.345 & 0.073$^{*}$   & 0.068$^{*}$   & 0.016 & 0.079$^{*}$   & 0.018 \\\hline
$f_{ling*TR^{(global)}}$     & 0.477    & 0.347 & 0.069 & 0.067$^{*}$   & 0.015 & 0.079$^{*}$   & 0.016 \\\hline
$f_{\text{ling}*TR^{(cluster)}}$     & 0.473    & 0.338$^{\dagger}$ & 0.068$^{\dagger}$ & 0.063$^{\dagger}$ & 0.014$^{\dagger}$ & 0.073$^{\dagger}$ & 0.016$^{\dagger}$ \\\hline
$f_{ling*TR^{(temp)}}$   & 0.448    & \textbf{0.356}$^{a}$  & \textbf{0.075}$^{*}$  & \textbf{0.071}    & \textbf{0.018}    & \textbf{0.084}$^{*}$  & \textbf{0.020}$^{b}$ \\\hline
\multicolumn{8}{|l|}{ \textit{Document-Guided Clustering + ILP + Date Selection (Baseline)} }\\\hline
$f_{\text{ling}*TR^{(cluster)}}$     & \textbf{0.521}$^{\dagger\ddagger}$   & 0.131 & 0.026 & 0.018 & 0.004 & 0.021 & 0.004 \\\hline
\hline\multicolumn{8}{|l|}{ \textbf{Crisis}}\\\hline
\multicolumn{8}{|l|}{ \textit{Agglomerative Clustering} }\\\hline
