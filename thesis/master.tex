...
$f_{ling*TR^{(date)}}$   & 0.446    & 0.302 & 0.056 & 0.056 & 0.013 & 0.068 & 0.014 \\\hline
$f_{ling*TR^{(global)}}$     & 0.460    & 0.315 & 0.063$^{b}$   & 0.059 & 0.013 & 0.070 & 0.015 \\\hline
$f_{\text{ling}*TR^{(cluster)}}$     & 0.461    & 0.305$^{\dagger}$ & 0.058$^{\dagger}$ & 0.059$^{\dagger}$ & 0.014$^{\dagger}$ & 0.069$^{\dagger}$ & 0.016$^{\dagger}$ \\\hline
$f_{ling*TR^{(temp)}}$   & 0.452    & 0.308 & 0.058 & 0.059 & 0.014$^{a}$   & 0.070 & 0.016$^{a}$ \\\hline
\multicolumn{8}{|l|}{ \textit{Affinity Propagation} }\\\hline
$f_{ling*TR^{(date)}}$   & 0.474    & 0.347 & 0.074$^{*}$   & 0.073$^{*}$   & 0.017 & 0.084$^{*}$   & 0.019 \\\hline
$f_{ling*TR^{(global)}}$     & 0.515$^{*}$  & 0.352 & 0.071 & 0.073$^{*}$   & 0.016 & 0.084$^{*}$   & 0.017 \\\hline
$f_{\text{ling}*TR^{(cluster)}}$     & 0.509    & 0.338$^{\dagger}$ & 0.068$^{\dagger}$ & 0.067$^{\dagger}$ & 0.014$^{\dagger}$ & 0.076$^{\dagger}$ & 0.016$^{\dagger}$ \\\hline
$f_{ling*TR^{(temp)}}$   & 0.488    & \textbf{0.361}$^{*}$  & \textbf{0.077}$^{*}$  & \textbf{0.078}$^{*}$  & \textbf{0.020}$^{*}$  & \textbf{0.090}$^{*}$  & \textbf{0.022}$^{*}$ \\\hline
\multicolumn{8}{|l|}{ \textit{Document-Guided Clustering} }\\\hline
$f_{\text{ling}*TR^{(cluster)}}$     & \textbf{0.559}$^{\dagger\dagger}$    & 0.120 & 0.025 & 0.020 & 0.005 & 0.022 & 0.005 \\\hline
\hline\multicolumn{8}{|l|}{ \textbf{Crisis}}\\\hline
\multicolumn{8}{|l|}{ \textit{Agglomerative Clustering} }\\\hline
