...
class SimilarityConstraint:
    def __init__(self, id_sentence_map, threshold=0.5):
        ...
        model = TfidfVectorizer(stop_words="english", max_features=5000, min_df=2)
...
class SubModularOptimizer:
    ...
    def run(self, sentences, id_to_sent_dict=None):
...
#
            ...
            if best_sentence is None:
                ...
                if id_to_sent_dict:
                    logger.info(" ".join(map(lambda x: x[0], id_to_sent_dict[best_sentence])))
